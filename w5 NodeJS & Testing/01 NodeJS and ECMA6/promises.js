...
function reverse(string) {
  ...
  //   resolve(reversed)
  // })
  return new Promise((resolve, reject) => resolve(string.split('').reverse().join('')));
}
...
function capitalizeLast(string) {
  return new Promise((res, rej) => res(string.slice(0, string.length-1) + string.charAt(string.length-1).toUpperCase()));
}
